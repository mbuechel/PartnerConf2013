...
/**
 * Class that defines WebElements and methods for the Tickets entity views on the Mobile Client.
 * 
...
public class TicketViewsElements extends BrowserSetup {
	...
	//-------
	/**
	 * This method captures the contents of the Tickets List view and return the same contents in a string. 
	 * 
	 * @version	1.0
	 * @return	String
	 */	
