...
/**
 * Class that defines WebElements and methods for the Contact views on the Mobile Client.
 * 
...
public class ContactViewsElements extends BrowserSetup {
	...
	//-------
	/**
	 * This method captures the contents of the Contacts List view and return the same contents in a string. 
	 * 
	 * @version	1.0
	 * @return	String
	 */	
	...
	//TODO: finish doSearchContact() method
