...
/**
 * Class that defines WebElements and methods for the Lead entity views on the Mobile Client.
 * 
...
public class LeadViewsElements extends BrowserSetup {
	...
	//-------
	/**
	 * This method captures the contents of the Leads List view and return the same contents in a string. 
	 * 
	 * @version	1.0
	 * @return	String
	 */	
