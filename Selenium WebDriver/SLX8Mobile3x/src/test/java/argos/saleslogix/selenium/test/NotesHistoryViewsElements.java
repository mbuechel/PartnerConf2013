...
/**
 * Class that defines WebElements and methods for the Notes History views on the Mobile Client.
 * 
...
public class NotesHistoryViewsElements extends BrowserSetup {
	...
	*/
	...
	//-------
	/**
	 * This method captures the contents of the Notes History List view and return the same contents in a string. 
	 * 
	 * @version	1.0
	 * @return	String
	 */	
