...
/**
 * Class that defines WebElements and methods for the Opportunity views on the Mobile Client.
 * 
...
public class OpportunityViewsElements extends BrowserSetup {
	...
	//-------
	/**
	 * This method captures the contents of the Opportunities List view and return the same contents in a string. 
	 * 
	 * @version	1.0
	 * @return	String
	 */	
