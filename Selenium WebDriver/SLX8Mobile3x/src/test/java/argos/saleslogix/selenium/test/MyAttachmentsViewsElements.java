...
/**
 * Class that defines WebElements and methods for the My Attachments views on the Mobile Client.
 * 
...
public class MyAttachmentsViewsElements extends BrowserSetup {
	...
	//-------
	/**
	 * This method captures the contents of the My Attachments List view and return the same contents in a string. 
	 * 
	 * @version	1.0
	 * @return	String
	 */	
